...
void view_set_module_day_layout(Evas_Object *layout)
{
	...
	w_info.module_day_layout = layout;
}
...
void view_set_module_second_layout(Evas_Object *layout)
{
	...
	w_info.module_second_layout = layout;
}
...
void view_set_module_minute_layout(Evas_Object *layout)
{
	...
	w_info.module_minute_layout = layout;
}
...
{
	return w_info.module_day_layout;
}
...
{
	return w_info.module_second_layout;
}
...
{
	return w_info.module_minute_layout;
}
...
{
	if (w_info.module_day_layout)
	{
		evas_object_del(w_info.module_day_layout);
		w_info.module_day_layout = NULL;
	}

	if (w_info.module_second_layout)
	{
		evas_object_del(w_info.module_second_layout);
		w_info.module_second_layout = NULL;
	}

	if (w_info.plate)
	{
		evas_object_del(w_info.plate);
		w_info.plate = NULL;
	}

	if (w_info.bg)
	{
		evas_object_data_del(w_info.bg, "__HANDS_SEC__");
		evas_object_data_del(w_info.bg, "__HANDS_SEC_SHADOW__");
		evas_object_data_del(w_info.bg, "__HANDS_MIN__");
		evas_object_data_del(w_info.bg, "__HANDS_MIN_SHADOW__");
		evas_object_data_del(w_info.bg, "__HANDS_HOUR__");
		evas_object_data_del(w_info.bg, "__HANDS_HOUR_SHADOW__");
		evas_object_data_del(w_info.bg, "__HANDS_BAT__");
		evas_object_data_del(w_info.bg, "__HANDS_BAT_SHADOW__");
		evas_object_del(w_info.bg);
		w_info.bg = NULL;
	}
}
